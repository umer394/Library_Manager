...
user_age = st.number_input(label="Age",placeholder="Enter Your Age:")
user_phone = st.number_input(label="Phone",placeholder="Enter Your Phone Number:")
# st.button("Register")
if(st.button("Register")):
    ...
    while (start):
        ...
        if(user_name and user_phone and user_age):
            ...
            input_choice = int(st.number_input("Enter your choice:"))
